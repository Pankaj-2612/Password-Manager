                ...
                <tbody className='bg-slate-500 text-white text-center'>
                  {passwordarray.map((item, index) => (
                    <tr key={item._id} className="border-t">
                      <td className='my-2'><a href={item.site} target='_blank' rel='noreferrer'>{item.site}</a> <img onClick={() => copysite(item.site)} className=' cursor-pointer w-5 h-5 inline-block ml-2' src={`${iconBase}/copy.svg`} alt="Copy" /></td>
